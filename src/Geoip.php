...
class Geoip
{
     ...
     * @var array
     */
    protected static $iso_3166_countryCodes = [
        'A1' => 'Anonymous Proxy',
    ...
    public static function ip2country_check()
    {
        ...
        $checks = [
            'www.paradise.net.nz' => ['code' => 'NZ', 'name' => 'New Zealand'],
            'www.gov.au' => ['code' => 'AU', 'name' => 'Australia'],
            'www.google.com' => ['code' => 'US', 'name' => 'United States'],
        ...
        foreach ($checks as $url => $expectedResponse) {
            ...
            if (! $response && $expectedResponse) {
                user_error("ip2country_check failed sanity check: ip2country({$url}) returned false. Expected code: '" . print_r($expectedResponse, 1) . "'", E_USER_WARNING);
                $status = false;
